!(function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(1),
      i = n(2),
      o = ".skinscan-progress-further, .w-radio",
      a = ".skinscan-progress-backwards";
    function s(e) {
      var t = 0;
      return (
        e.each(function () {
          t += parseInt(i(this).attr("data-score"));
        }),
        t
      );
    }
    i(".skinscan-form").each(function () {
      var e = i(this);
      !(function (e) {
        var t = e.find(".w-slide"),
          n = e.find(".w-slider-arrow-left"),
          u = e.find(".w-slider-arrow-right");
        e.on("click", o, function (e) {
          e.preventDefault(), e.stopImmediatePropagation(), e.stopPropagation();
          var n = i(this).closest(".w-slide");
          return (
            t.filter(function () {
              return (
                "visible" == n.css("visibility") &&
                void 0 !== n.attr("data-score")
              );
            }).length > 0 &&
              (s(t),
              setTimeout(function () {
        ...
        (function (e) {
          ...
          t.each(function () {
            i(this)
              .find("[data-score]")
              .on("click", function () {
                var e = i(this).attr("data-score");
                i(this).closest(".w-slide").attr("data-score", e),
                  (function (e) {
                    var t = 0,
                      n = e.closest(".skinscan-form");
                    e.filter("[data-score]").each(function () {
                      var e = i(this);
                      t += parseInt(e.attr("data-score"));
                    }),
                      e.each(function () {
                        i(this);
                        var e = n.find("[data-skin-type]");
                        e.css("display", "none");
                        var r = null;
                        e.each(function () {
                          t >= parseInt(i(this).attr("data-skin-type")) &&
                            (r = i(this));
                        }),
                          r && r.css("display", "block");
                      });
                  })(t);
              });
          });
  ...
  function (e, t, n) {
    ...
    t.a = function (e, t) {
      ...
      if (document.createEvent)
        (n = document.createEvent(s)),
          "HTMLEvents" == s
            ? n.initEvent(t, a.bubbles, a.cancelable)
            : n.initMouseEvent(
                t,
                a.bubbles,
                a.cancelable,
    ...
    !(function (t, n) {
        ...
        function se(e, t, r, i) {
          ...
          if (!i && (p(t), (t = t || d), g)) {
            ...
            if (
              ...
              if (((y = e), (m = t), 1 === w && (z.test(e) || X.test(e)))) {
                for (
        ...
        special: {
          ...
          click: {
            ...
            trigger: function (e) {
              var t = this || e;
              return (
                ge.test(t.type) && t.click && N(t, "input") && je(t, "click"),
                !0
              );
            },
            _default: function (e) {
      ...
      function Pe(e, t) {
        ...
        if (1 === t.nodeType) {
          ...
          J.hasData(e) &&
            ((o = J.access(e)), (a = C.extend({}, o)), J.set(t, a));
        }
      }
      function Me(e, t, n, r) {
        t = u(t);
        ...
        if (
          ...
          if (s)
            for (
              c = a[a.length - 1].ownerDocument, C.map(a, Oe), f = 0;
              f < s;
              f++
            )
              (l = a[f]),
      ...
      C.extend({
        ...
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (a = xe(c), r = 0, i = (o = xe(e)).length; r < i; r++)
              (s = o[r]),
                (u = a[r]),
                void 0,
                "input" === (l = u.nodeName.toLowerCase()) && ge.test(s.type)
                  ? (u.checked = s.checked)
                  : ("input" !== l && "textarea" !== l) ||
          ...
          return (
            (a = xe(c, "script")).length > 0 && be(a, !f && xe(e, "script")), c
          );
        },
      ...
      C.extend(C.event, {
        trigger: function (e, t, r, i) {
          ...
          if (
            ...
            if (!i && !f.noBubble && !m(r)) {
              for (
                u = f.delegateType || g, xt.test(u + g) || (a = a.parentNode);
                a;
                a = a.parentNode
              )
                h.push(a), (s = a);
      ...
      return (
        (C.noConflict = function (e) {
          return (
            n.$ === C && (n.$ = Kt), e && n.jQuery === C && (n.jQuery = Yt), C
          );
        }),
